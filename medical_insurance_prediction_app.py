...
loaded_model = pickle.load(open('/Users/mac/TR-Machine_Learning_Main_Projects/medical_insurance_model.sav','rb'))
loaded_encoder = pickle.load(open('/Users/mac/TR-Machine_Learning_Main_Projects/One_Hot_Encoder.sav','rb'))
loaded_scaler = pickle.load(open('/Users/mac/TR-Machine_Learning_Main_Projects/Scaler.sav','rb'))
...
def main():
    ...
    local_css('/Users/mac/Downloads/Model_Deployment/STREAMLIT_examples/style.css')        
